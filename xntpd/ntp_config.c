...
#define CONFIG_SETVAR		24
#define CONFIG_CLIENTLIMIT	25
#define CONFIG_CLIENTPERIOD	26
#define CONFIG_MULTICASTCLIENT	27
#define CONFIG_ENABLE		28
#define CONFIG_DISABLE		29
